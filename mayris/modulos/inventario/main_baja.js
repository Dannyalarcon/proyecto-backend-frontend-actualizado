...
var appInventario = new Vue({
  ...
  methods: {
    ...
    btnBorrar: function (id_inventario) {
      Swal.fire({
        title: "¿Está seguro de borrar el producto Numero: " + id_inventario + " ?",
        type: "warning",
        showCancelButton: true,
    ...
    btnAlta: function (id_inventario) {
      Swal.fire({
        title: "¿Está seguro de dar alta el producto Numero: " + id_inventario + " ?",
        type: "warning",
        showCancelButton: true,
        confirmButtonColor: "#1cc88a",
        cancelButtonColor: "#3085d6",
    ...
    altaMovil: function (id_inventario) {
      axios.post(url, { opcion: 6, id_inventario: id_inventario }).then((response) => {
        this.listarMoviles();
      });
    },
  },
