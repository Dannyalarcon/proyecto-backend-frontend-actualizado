...
var appInventario = new Vue({
  ...
  methods: {
    ...
    btnBorrar: function (id_empleados) {
      Swal.fire({
        title: "¿Está seguro dar de baja al empleado Numero: " + id_empleados + " ?",
        type: "warning",
        showCancelButton: true,
    ...
    borrarMovil: function (id_empleados) {
      axios.post(url, { opcion: 3, id_empleados: id_empleados }).then((response) => {
        this.listarMoviles();
      });
    },
  },
