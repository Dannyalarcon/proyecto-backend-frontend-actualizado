...
<head>
    ...
    <title>Inventario Sin Stock</title>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-light border-right" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                ...
                <a href="inventario.php" class="list-group-item list-group-item-action nav-item active">Inventario</a>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container">
                ...
                <?php
                include_once "modulos/inventario/index_baja.html";
                ?>
